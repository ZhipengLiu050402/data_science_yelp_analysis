...
from models.bert_cat import BERTCatClassifier
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train BERT+Cat on Yelp unified dataset.")
    ...
    parser.add_argument("--output_dir", type=str, default="outputs/checkpoints/bert_cat")
