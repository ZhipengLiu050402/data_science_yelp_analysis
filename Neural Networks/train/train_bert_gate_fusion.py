...
def parse_args():
    parser = argparse.ArgumentParser(description="Train BERT+GateFusion on Yelp unified dataset.")
    ...
    parser.add_argument("--output_dir", type=str, default="outputs/checkpoints/bert_gate_fusion")
